...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed top-0 left-0 z-50 flex items-center justify-between px-4 md:px-10 py-2 md:py-3 glass-card bg-[#181A20]/80 backdrop-blur-lg border-b border-[#23272F]/60 shadow-lg" aria-label="Main navigation" style={{ borderRadius: 0 }}>
